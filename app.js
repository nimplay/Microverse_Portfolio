...
`;
  function cardDefault(projectData, index) {
    document.querySelector(".pop-up-title").textContent =
      projectData[index].title;
    document.querySelector("#lenguage1").textContent =
      projectData[index].lenguage1;
    document.querySelector("#lenguage2").textContent =
      projectData[index].lenguage2;
    document.querySelector("#lenguage3").textContent =
      projectData[index].lenguage3;
